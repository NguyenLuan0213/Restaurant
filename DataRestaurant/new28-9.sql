...
INSERT INTO `__efmigrationshistory` VALUES ('20230925085447_Initial','7.0.11'),('20230925090956_InitRole','7.0.11');
...
INSERT INTO `aspnetroles` VALUES ('600dcb41-d6de-44cb-8cc8-21562844c564','WAITER','WAITER','4'),('9bb1cda4-a489-4346-b983-bd43503607f4','CUSTORMER','CUSTORMER','2'),('bc4a88c3-92d6-4272-95df-122523c7d0d2','CASHIER','CASHIER','3'),('cf0b06de-0600-4d0d-b87d-00b9cf96f763','ADMIN','ADMIN','1');
...
INSERT INTO `aspnetuserroles` VALUES ('e74ba040-c22b-414d-a906-273196d98080','bc4a88c3-92d6-4272-95df-122523c7d0d2'),('d4413ed9-8b29-4570-befe-54152ee171d2','cf0b06de-0600-4d0d-b87d-00b9cf96f763');
...
INSERT INTO `aspnetusers` VALUES ('d436c738-955e-4425-b448-21d78e6e4025','admin123','ADMIN123','admin123@gmail.com','ADMIN123@GMAIL.COM',0,'AQAAAAEAACcQAAAAEIGZGKBil0k3K2eLtgyjPwLn/aR4jof3nGEky5bZ2m40WSkMtePYh4wHyfT+wAKsFw==','UHAQOXDSYWHVQZQC4XFPYBNYJBEQDHQZ','94ec8937-204e-4f66-ad1d-0dc19e0485f8',NULL,0,0,NULL,1,0),('d4413ed9-8b29-4570-befe-54152ee171d2','admin','ADMIN','admin@gmail.com','ADMIN@GMAIL.COM',0,'AQAAAAEAACcQAAAAEFJ8ndQB8zpR0rqRv4IyMbVW7zO9dxxQFVrvSjn3WOPZEUnZlesJj7p9LmHqWu283A==','P6V3HFLDTZHIHAYBZSAZLRUIAZSDTH2E','ffadcebf-1248-44b4-8cd2-8f1ce2e941cf',NULL,0,0,NULL,1,0),('e74ba040-c22b-414d-a906-273196d98080','cashier123','CASHIER123','cashier123@gmail.com','CASHIER123@GMAIL.COM',0,'AQAAAAEAACcQAAAAEH/3+ZMJNnxjqLR1P05qzhYA4e7vDzTvRd6qB46qzbg9aBpzRwNicfU3fpU56YbOoA==','FT5LIXF52THIW65A6MQNKCC5XZJCLMOA','a4d716f0-0e1d-4013-91ac-1d23651f3a45',NULL,0,0,NULL,1,0);
...
CREATE TABLE `tables` (
  ...
  CONSTRAINT `fk_restaurant_waiter` FOREIGN KEY (`id_waiter`) REFERENCES `users` (`id`)
...
CREATE TABLE `users` (
  ...
  `roles` enum('ADMIN','CUSTOMER','WAITER','CASHIER') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,NULL,NULL,'nguyenvana@gmail.com','Nguyễn Văn An','0123456781','Hà Nội','WAITER',NULL),(2,NULL,NULL,'tranthibinh@gmail.com','Trần Thị Bình','0123456782','Hồ Chí Minh','WAITER',NULL),(3,NULL,NULL,'lehongcuong@gmail.com','Lê Hồng Cường','0123456783','Đà Nẵng','WAITER',NULL),(4,NULL,NULL,'hoangquocdung@gmail.com','Hoàng Quốc Dũng','0123456784','Huế','WAITER',NULL),(5,NULL,NULL,'trinhthilan@gmail.com','Trịnh Thị Lan','0123456785','Nha Trang','WAITER',NULL),(6,NULL,NULL,'phamminhphong@gmail.com','Phạm Minh Phong','0123456786','Cần Thơ','WAITER',NULL),(7,NULL,NULL,'levangiang@gmail.com','Lê Văn Giang','0123456787','Vinh','WAITER',NULL),(8,NULL,NULL,'nguyenhaiyen@gmail.com','Nguyễn Hải Yến','0123456788','Quy Nhơn','WAITER',NULL),(9,NULL,NULL,'dothiminh@gmail.com','Đỗ Thị Minh Anh','0123456789','Phan Thiết','WAITER',NULL),(10,NULL,NULL,'phamvantien@gmail.com','Phạm Văn Tiến','0123456790','Tam Kỳ','WAITER',NULL),(11,'ntu123','123456','nguyenthiuyen@gmail.com','Nguyễn Thị Uyên','0123485789','Phan Thiết','CASHIER',NULL),(12,'ptt123','123456','phamthanh@gmail.com','Phạm Thanh Thanh','0123496790','Tam Kỳ','CASHIER',NULL),(13,'lhc123','123456','lecuong@gmail.com','Lê Hồng Cường','0123456791','Đà Nẵng','CUSTOMER',NULL),(14,'hqd123','123456','hoangdung@gmail.com','Hoàng Quốc Dũng','0123456792','Huế','CUSTOMER',NULL),(15,'ttl123','123456','trinhlan@gmail.com','Trịnh Thị Lan','0123456793','Nha Trang','CUSTOMER',NULL),(16,'pmp123','123456','phongpham@gmail.com','Phạm Minh Phong','0123456794','Cần Thơ','CUSTOMER',NULL),(17,NULL,NULL,'voanhkiet@gmail.com','Võ Anh Kiệt','0123456795','Đà Nẵng','WAITER',NULL),(18,NULL,NULL,'lethicattuong@gmail.com','Lê Thị Cát Tường','0123456796','Đắk Lắk','WAITER',NULL),(19,NULL,NULL,'hoquangdat@gmail.com','Hồ Quang Đạt','0123456797','Hồ Chí Minh','WAITER',NULL),(20,NULL,NULL,'nguyenngocanhthu@gmail.com','Nguyễn Ngọc Anh Thư','0123456798','Huế','WAITER',NULL),(21,NULL,NULL,'buitienhung@gmail.com','Bùi Tiến Hùng','0123456799','Nha Trang','WAITER',NULL),(22,'tqd123','123456','tranquangdat@gmail.com','Trần Quang Đạt','0123456800','Gia Lai','CASHIER',NULL),(23,'admin','admin','admin123@gmail.com','Nguyễn Ngọc Luân','0819998584','Bình Thuận','ADMIN',NULL);
...
-- Dump completed on 2023-09-28 16:42:31
